    ...
    <div class="container-fluid">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Hard Skill Score: <strong><?= $matrix_point['name'] ?></strong></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <a href="<?= base_url() ?>comp_settings/position_score/edit/<?= md5($matrix_point['id']) ?>" class="btn btn-primary w-100"><i class="fa fa-edit"></i> Edit</a><br><br>
